<%@ Page Title="" Language="C#" MasterPageFile="~/empzeno.Master" AutoEventWireup="true" CodeBehind="empreports.aspx.cs" Inherits="testzeno.WebForm13" %>
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                      <div class="col-lg-10 mx-auto">
                          ...
                          <asp:Chart ID="Chart2" runat="server" DataSourceID="SqlDataSource2" Width="888px" >
                            <Series>
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                      <div class="col-lg-10 mx-auto">
                          ...
                          <asp:Chart ID="Chart3" runat="server" DataSourceID="SqlDataSource2" Width="888px" >
                            <Series>
